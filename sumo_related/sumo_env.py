...
def start_new_run(run):
    ...
    global curr_state, prev_state, intn_control_action, intn_cur_action, first_act_of_run, counting_time, qlenfile, t_count_down
...
def calculate_reward(current_state, previous_state, intID, phase_num):
...
def time_pass_after_setting(intIDs, step_num = 1):
    ...
    global curr_state, prev_state, intn_control_action, intn_cur_action, first_act_of_run, counting_time, t, t_count_down
    ...
    for ts in range(step_num):
        ...
        for intID in intIDs:
            ...
            if flag[intID]:
                cnt += 1
                R += calculate_reward(curr_state[intID], prev_state[intID], intID, intn_control_action[intID])
